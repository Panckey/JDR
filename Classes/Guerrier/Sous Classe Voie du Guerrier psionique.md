...
##### ![🛡️](https://s.w.org/images/core/emoji/17.0.2/svg/1f6e1.svg) Champ protecteur (Protective Field)
...
##### ![💥](https://s.w.org/images/core/emoji/17.0.2/svg/1f4a5.svg) Frappe psionique (Psionic Strike)
...
##### ![🌀](https://s.w.org/images/core/emoji/17.0.2/svg/1f300.svg) Mouvement télékinétique (Telekinetic Movement)
...
- **Saut psionique (Psi-Powered Leap)**  
    ...
    Vous pouvez réutiliser cette aptitude en dépensant un dé psionique pour la restaurer.
- **Projection télékinétique (Telekinetic Thrust)**  
    Quand vous infligez des dégâts avec votre Frappe psionique, la cible doit réussir un jet de sauvegarde de Force (DD = 8 + bonus de maîtrise + mod. d’Intelligence), sinon :
    - vous la mettez à terre (Prone), ou
