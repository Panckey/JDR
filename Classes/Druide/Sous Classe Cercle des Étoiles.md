...
|---|---|
|1|Un parchemin orné de constellations dessinées à la main|
|2|Une tablette de pierre percée de minuscules trous formant des motifs célestes|
|3|Une peau de hibours gravée de symboles stellaires|
|4|Un recueil de cartes reliées dans une couverture d’ébène|
|5|Un cristal gravé de motifs d’étoiles|
|6|Un disque de verre finement gravé de constellations|

**Pouvoirs de la carte :**

- Tant que tu tiens ta carte, tu as toujours les sorts Guidance et Rayon guidant (Guiding Bolt) préparés.
- Tu peux lancer _Rayon guidant_ sans dépenser d’emplacement de sort, un nombre de fois égal à ton modificateur de Sagesse (minimum une fois).
