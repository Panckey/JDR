...
##### ![✔](https://s.w.org/images/core/emoji/17.0.2/svg/2714.svg) Points de vie

- Votre maximum de PV augmente de **3**.
- Il augmente de +1 supplémentaire chaque fois que vous gagnez un niveau d’Ensorceleur.

##### ![✔](https://s.w.org/images/core/emoji/17.0.2/svg/2714.svg) Armure naturelle
...
Lorsque vous atteignez les niveaux indiqués, vous avez _toujours_ ces sorts préparés.

|Niveau de l’Ensorceleur|Sorts|
|---|---|
|**3**|_Alter Self_, _Chromatic Orb_, _Command_, _Dragon’s Breath_|
|**5**|_Fear_, _Fly_|
|**7**|_Arcane Eye_, _Charm Monster_|
|**9**|_Legend Lore_, _Summon Dragon_|

#### Niveau 6 : Affinité Élémentaire

Votre magie draconique s’accorde avec un type élémentaire.

##### ![✔](https://s.w.org/images/core/emoji/17.0.2/svg/2714.svg) Choisissez un type de dégâts :
...
##### ![✔](https://s.w.org/images/core/emoji/17.0.2/svg/2714.svg) Version sans concentration
