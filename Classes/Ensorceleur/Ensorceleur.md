...
![ensorceleur de l'univers de donjon et dragon](https://i0.wp.com/donjonetdragon.fr/wp-content/uploads/2022/12/ensorceleur-donjon-et-dragon.jpg?resize=564%2C789&ssl=1)
...
Aux niveaux **4** et **10**, vous apprenez **un tour de magie supplémentaire**, comme indiqué dans la colonne _Cantrips_ du tableau des aptitudes.
...
Votre nombre total de sorts préparés augmente à mesure que vous montez de niveau, comme indiqué dans la colonne _Prepared Spells_ du tableau de la classe.
...
Avec la mise à jour de 2024, [les races](https://donjonetdragon.fr/univers/race/) offrent désormais une grande liberté de personnalisation. Certaines races renforcent naturellement le Charisme et la magie brute de l’ensorceleur.
...
Si le sort a une portée de _Contact_, vous pouvez augmenter sa portée à **9 m (30 ft)**.
...
**Coût : 1 point de sorcellerie**  
Quand vous lancez un sort (comme _Charme-personne_) pouvant cibler une créature supplémentaire en utilisant un emplacement supérieur, vous pouvez dépenser 1 point de sorcellerie pour **augmenter son niveau effectif de 1**, permettant ainsi de **cibler une créature supplémentaire**.
