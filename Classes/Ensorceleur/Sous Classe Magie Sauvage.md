...
![⚠️](https://s.w.org/images/core/emoji/17.0.2/svg/26a0.svg) Si l’effet déclenche un sort, il n’est pas affecté par vos options de Métamagie (trop instable).
...
- Une fois utilisé, vous devez soit :  
    ![✔](https://s.w.org/images/core/emoji/17.0.2/svg/2714.svg) lancer un sort d’Ensorceleur avec un emplacement,  
    ![✔](https://s.w.org/images/core/emoji/17.0.2/svg/2714.svg) **ou** terminer un repos long  
...
|**49–52**|Un bouclier spectral vous entoure 1 minute : +2 CA, immunité à _Projectiles magiques_.|
|**53–56**|Vous gagnez **une action supplémentaire immédiatement**.|
|**57–60**|Vous lancez un sort aléatoire sans concentration. 1: _Confusion_ ; 2: _Fireball_ ; 3: _Fog Cloud_ ; 4: _Fly_ (cible aléatoire) ; 5: _Grease_ ; 6: _Levitate_ (sur vous) ; 7: _Magic Missile_ niv.5 ; 8: _Mirror Image_ ; 9: _Polymorph_ (sur vous, chèvre si échec) ; 10: _See Invisibility_.|
|**61–64**|Tout objet inflammable non magique que vous touchez prend feu (1d4 dégâts).|
|**65–68**|Si vous mourrez dans l’heure, vous êtes immédiatement réincarné (_Reincarnate_).|
