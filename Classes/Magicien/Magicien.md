...
- Un [grimoire](https://donjonetdragon.fr/univers/classe/magicien/#grimoire)
...
> _DD de sauvegarde des sorts = 8 + votre bonus de maîtrise + votre modificateur d’Intelligence_
> 
> _Modificateur aux attaques avec un sort = votre bonus de maîtrise + votre modificateur d’Intelligence_

Grimoire :

Vous possédez un grimoire qui contient six sorts de magicien de niveau 1 de votre choix. [Votre grimoire](https://donjonetdragon.fr/univers/classe/magicien/#grimoire) est le gardien des sorts de magicien que vous connaissez, à exception des sorts mineurs qui sont eux fixés dans votre esprit.
...
> _Par exemple, si vous êtes un magicien de niveau 4, vous pouvez récupérer jusqu’à l’équivalent de deux niveaux d’emplacements de sorts. Vous pouvez récupérer soit un emplacement de sort de niveau 2 ou deux emplacements de sorts de niveau 1._
...
> _Si vous voulez lancer l’un de ses sorts à un niveau supérieur, vous devez dépenser un emplacement de sort, de manière normale. En passant 8 heures à étudier, vous pouvez échanger l’un ou les deux sorts que vous avez choisis par d’autres sorts de même niveau._
...
> _Une fois un sort lancé de cette manière, vous devez terminer un repos court ou long pour pouvoir le lancer de nouveau. Si vous voulez lancer un de ces sorts à un niveau supérieur, vous devez dépenser un emplacement de sort, de manière normale._
