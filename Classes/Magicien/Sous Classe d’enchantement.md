...
Ayant développé vos compétences en tant que membre de l’école d’enchantement, vous êtes capable de charmer magiquement les personnes et les monstres, certains enchanteurs utilisant leur art pour promouvoir la paix en ensorcelant les violents et en charmant les cruels pour les rendre plus miséricordieux, tandis que d’autres, tels des tyrans, forcent les récalcitrants à leur obéir par la magie, mais la plupart des enchanteurs se situent quelque part entre ces deux extrêmes.

## Les capacités de l’école de l’enchantement

### Ecole de l’enchantement niveau 2

Enchanteur érudit :

Lorsque vous choisissez cette école, l’or et le temps que vous devez dépenser pour copier un sort d’enchantement dans votre grimoire est divisé par deux.

Regard hypnotique :

 Vos paroles apaisantes et votre regard envoûtant peuvent captiver votre auditoire. Par une action, vous choisissez une créature que vous pouvez voir située à 1,50 mètre ou moins de vous. Si la cible peut vous voir ou vous entendre, elle doit réussir un jet de sauvegarde de Sagesse contre le DD de sauvegarde de vos sorts de magicien, ou vous la charmez jusqu’à la fin de votre prochain tour. La vitesse de la créature charmée est réduite à 0, elle est incapable d’agir, et visiblement étourdie. À chaque tour suivant, vous pouvez utiliser votre action pour maintenir cet effet, prolongeant alors sa durée jusqu’à la fin de votre prochain tour.

> _Cependant, cet effet se termine si vous vous déplacez à plus de 1,50 mètre de la créature, si celle-ci ne peut plus ni vous voir ni vous entendre, ou si elle subit des dégâts. Une fois que l’effet prend fin, ou si la créature réussit son jet de sauvegarde initial contre cet effet, vous ne pouvez plus utiliser cette capacité contre cette créature jusqu’à ce que vous terminiez un repos long._

### Ecole de l’enchantement niveau 6
...
Lorsque vous lancez un sort d’enchantement de niveau 1 ou plus ayant pour cible une seule créature, vous pouvez choisir de cibler avec ce sort une seconde créature.

### Ecole de l’enchantement niveau 14
