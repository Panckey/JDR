...
En qualité d’étudiant en sorts de transmutation, vous considérez le monde comme étant malléable, ce qui vous procure une grande satisfaction en tant qu’agent de son changement, car vous manipulez la matière brute de la création pour modifier tant les formes physiques que les qualités mentales, et ainsi devenir un forgeron de la réalité ; certains transmuteurs s’amusent à transformer les gens en crapauds ou le cuivre en argent, tandis que d’autres se consacrent sérieusement à l’étude de la magie, cherchant à atteindre la puissance divine pour façonner et défaire le monde.
## Les capacités de l’école de transmutation

### Ecole de transmutation niveau 2
...
### Ecole de transmutation niveau 10

Métamorphe :

vous ajoutez le sort [_métamorphose_](https://donjonetdragonsort.fr/detailSort?Magicien?Metamorphose) dans votre livre de sorts, s’il n’y est pas déjà inscrit. Vous pouvez lancer _métamorphose_ sans dépenser d’emplacement de sort. En lançant le sort de cette manière, vous ne pouvez que vous cibler vous-même et vous transformer en une bête dont le facteur puissance est de 1 ou moins. Après avoir lancé _métamorphose_ de cette manière, vous ne pouvez plus le faire jusqu’à ce que vous terminiez un repos court ou long, bien que vous puissiez le lancer normalement en utilisant un emplacement de sort disponible.

### Ecole de transmutation niveau 14
