...
![Occultiste donjon et dragon 5](https://i0.wp.com/donjonetdragon.fr/wp-content/uploads/2022/10/occultiste-donjons-et-dragons.jpeg?resize=235%2C331&ssl=1)
...
|Niveau de l’Occultiste|Bonus de maîtrise|Aptitudes de classe|Invocations occultes|Tours de magie|Sorts préparés|Emplacements de sorts|Niveau des emplacements|
|---|---|---|---|---|---|---|---|
|**1**|+2|Invocations occultes, Magie de pacte|1|2|2|1|1|
|**2**|+2|Ruse magique|2|2|3|2|1|
|**3**|+2|Sous-classe d’occultiste|3|2|4|2|2|
|**4**|+2|Amélioration de caractéristiques|3|3|5|2|2|
|**5**|+3|—|4|3|6|2|3|
|**6**|+3|Aptitude de sous-classe|5|3|7|2|3|
|**7**|+3|—|6|3|8|2|4|
|**8**|+3|Amélioration de caractéristiques|6|3|9|2|4|
|**9**|+4|Contacter le Patron|7|3|10|2|5|
|**10**|+4|Aptitude de sous-classe|7|4|11|2|5|
|**11**|+4|Arcanum mystique (sort de niveau 6)|8|4|11|3|5|
|**12**|+4|Amélioration de caractéristiques|8|4|12|3|5|
|**13**|+5|Arcanum mystique (sort de niveau 7)|8|4|13|3|5|
|**14**|+5|Aptitude de sous-classe|8|4|13|3|5|
|**15**|+5|Arcanum mystique (sort de niveau 8)|9|4|14|3|5|
|**16**|+5|Amélioration de caractéristiques|9|4|14|3|5|
|**17**|+6|Arcanum mystique (sort de niveau 9)|10|4|15|4|5|
|**18**|+6|—|10|4|15|4|5|
|**19**|+6|Don épique|10|4|15|4|5|
|**20**|+6|Maître occulte|10|4|15|4|5|
...
Vous gagnez une invocation de votre choix, comme _Pacte du Grimoire_.  
...
Lorsque vous atteignez certains niveaux d’occultiste, vous gagnez davantage d’invocations au choix, comme indiqué dans la colonne _Invocations_ du tableau des aptitudes d’occultiste.
...
S’il lance _Trait sorcière (Witch Bolt)_, un sort de niveau 1, il doit dépenser un de ces emplacements — et il le lance comme un sort de niveau 3.
...
Votre patron _définit votre identité_ :  
...
Avec la mise à jour de 2024, [les races](https://donjonetdragon.fr/univers/race/) offrent désormais une grande liberté de personnalisation. Mais certaines races renforcent naturellement le style de jeu charismatique, surnaturel ou manipulateur de l’occultiste.

#### [Tieffelin](https://donjonetdragon.fr/univers/race/tieffelin/)

Un classique absolu.  
Résistance au feu, affinité naturelle avec la magie, aura infernale… parfait pour un pacte fiélon, fée noire ou Grand Ancien.

#### [Aasimar](https://donjonetdragon.fr/univers/race/aasimar/)
...
Les _Invocations mystiques_ sont l’un des outils les plus puissants de l’Occultiste. Elles représentent des fragments de savoir interdit, offerts par le patron ou arrachés aux profondeurs du multivers. Ces invocations permettent :

- d’améliorer des sorts (comme _Rayon occulte_),
