![escroc arcanique donjon et dragon 5e édition](https://i0.wp.com/donjonetdragon.fr/wp-content/uploads/2022/08/roublard-escroc-arcanique-donjon-et-dragon-5e-e%CC%81dition.jpeg?resize=564%2C775&ssl=1)

### Arcane Trickster

_Renforcer la discrétion grâce à la magie profane_
...
- Deux autres cantrips de [la liste de Magicien](https://www.aidedd.org/dnd-filters/sorts.php)  
    _Recommandés : Mind Sliver et Minor Illusion._

À chaque fois que vous gagnez un niveau de roublard, vous pouvez remplacer l’un de vos cantrips (sauf _Mage Hand_) par un autre sort de magicien.

Au niveau 10, vous apprenez un cantrip supplémentaire du magicien.

##### Emplacements de sorts

Le tableau _Arcane Trickster Spellcasting_ indique combien d’emplacements vous possédez pour lancer des sorts de niveau 1 ou plus.  
...
_Recommandés : Charm Person, Disguise Self et Fog Cloud._

Votre nombre de sorts préparés augmente selon la colonne _Prepared Spells_.
...
Lorsque vous lancez _Mage Hand_ :
...
Votre _Mage Hand_ devient encore plus perturbatrice.

Quand vous utilisez l’option Trip (= Faire trébucher) de votre _Cunning Strike_ sur une créature :
...
1. Forcer un jet de sauvegarde d’Intelligence contre votre DD de sauvegarde.
2. En cas d’échec :
