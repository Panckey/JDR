...
|---|---|
|3|_Fléau (Bane)_, _Marque du chasseur (Hunter’s Mark)_|
|5|_Immobiliser une personne (Hold Person)_, _Pas brumeux (Misty Step)_|
|9|_Hâte (Haste)_, _Protection contre l’énergie (Protection from Energy)_|
|13|_Bannissement (Banishment)_, _Porte dimensionnelle (Dimension Door)_|
|17|_Immobiliser un monstre (Hold Monster)_, _Scrutation (Scrying)_|
