...
Lorsque vous utilisez Rafale de coups (Flurry of Blows), vous pouvez remplacer l’une de vos attaques par une utilisation de _Main de guérison_, sans dépenser de point de Focus pour cette guérison. Ainsi, vous maniez la compassion avec la même maîtrise que la violence.
...
- Lorsque vous utilisez Rafale de coups, vous pouvez remplacer chacune de vos frappes par une utilisation de _Main de guérison_ sans dépenser de point de Focus.
- De plus, lorsque vous touchez une créature avec une attaque de _Rafale de coups_ et lui infligez des dégâts, vous pouvez lui appliquer _Main du mal_ sans dépenser de point de Focus.  
    Vous ne pouvez toutefois utiliser _Main du mal_ qu’une seule fois par tour.
