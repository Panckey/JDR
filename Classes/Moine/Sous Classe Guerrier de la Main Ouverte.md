...
- **Déstabilisation (Addle).**  
    La cible ne peut pas effectuer d’attaques d’opportunité jusqu’au début de son prochain tour.
- **Poussée (Push).**  
    La cible doit réussir un jet de sauvegarde de Force, sans quoi elle est repoussée jusqu’à 4,5 mètres (15 pieds) de vous.
- **Renversement (Topple).**  
