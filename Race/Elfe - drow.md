...
_Mise à jour de 2025 basée sur la dernière version des règles de Dungeons & Dragons_
...
Les Drows sont des elfes des ténèbres, descendants des elfes classiques, adaptés à la vie souterraine. Cette ascendance leur confère une grande agilité et une affinité innée avec la magie noire.

---

### Vision dans le noir

Vous disposez d’une **vision dans le noir sur 18 m**, héritée de vos ancêtres drow, vous permettant de voir dans l’obscurité totale comme si elle était tamisée.

---

### Résistance magique

Vous avez une **avantage sur les jets de sauvegarde contre les sorts** et les effets magiques créés par d’autres créatures, sauf si un pouvoir ou objet le contredit explicitement.

---

### Sens surnaturels

Vous pouvez détecter la présence de créatures dans un rayon de **9 m** en utilisant votre perception supérieure, même à travers de petites barrières légères (comme des buissons ou des portes partiellement ouvertes).

- Les créatures invisibles ou étourdies ne sont pas détectées.
...
- **Sorts innés** : à partir du niveau 3, vous pouvez lancer les sorts suivants **une fois par repos long** :
    
    - _Dancing Lights_ (lumières dansantes)
        
    - _Faerie Fire_ (niveau 1)
        
    - _Darkness_ (niveau 2)
        
- Le **modificateur de Charisme** est utilisé pour ces sorts.
    
- Le niveau du sort ne peut pas être augmenté.
...
- Vous avez **avantage sur les jets de sauvegarde pour éviter d’être surpris** ou pris au dépourvu.
    
- Vous pouvez également vous déplacer **de manière silencieuse** sans pénalité, même en armure légère.
...
- Vous êtes **compétent avec les rapières, les épées courtes et les arbalètes légères**.
    
- Vous bénéficiez d’un **bonus de +2 aux attaques de finesse** avec ces armes.
    

---

### Déplacement spectral (niveau 5)

À partir du niveau 5, vous pouvez utiliser la magie des ténèbres pour vous **fondre dans l’ombre** :

- En utilisant une **action bonus**, vous pouvez vous déplacer jusqu’à 9 m supplémentaires sans provoquer d’attaque d’opportunité.
    
- Ce pouvoir peut être utilisé **un nombre de fois égal à votre bonus de maîtrise**, et se recharge après un **repos long**.
...
![UA-Outreterre](https://www.aidedd.org/assets/intro/articles/UA/UA-outreterre.jpg)
