...
![Gith homme D&D](https://i0.wp.com/donjonetdragon.fr/wp-content/uploads/2023/09/gith-homme-dnd.webp?resize=400%2C400&ssl=1)
...
**Pouvoirs psioniques Githyanki:** Vous êtes familier avec le sort mineur _main de mage_. À partir du niveau 3, vous pouvez lancer _saut_ une fois entre deux repos longs. À partir du niveau 5, vous pouvez lancer _foulée brumeuse_ une fois entre deux repos longs. L’Intelligence est la caractéristique utilisée pour l’incantation de ces sorts, que vous pouvez lancer sans avoir besoin de composantes.
...
**Pouvoirs psioniques Githzerai :** Vous maîtrisez le sort mineur _main de mage_. À partir du niveau 3, vous pouvez lancer _bouclier_ une fois entre deux repos longs. À partir du niveau 5, vous pouvez lancer _détection des pensées_ une fois entre deux repos longs. La Sagesse est la caractéristique que vous utilisez pour l’incantation de ces sorts, que vous pouvez lancer sans composantes.
